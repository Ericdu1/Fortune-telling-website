...
export const characterImageMap: Record<string, string> = {
  ...
  '西撒·齐贝林': 'Caesar_Anthonio_Zeppeli.webp',
  '空条承太郎': 'Jotaro_Kujo.webp',
  '花京院典明': 'Noriaki_Kakyoin.webp',
  '东方仗助': 'Josuke_Higashikata.webp',
  '岸边露伴': 'Rohan_Kishibe.webp',
  '乔鲁诺·乔巴拿': 'Giorno_Giovanna.webp',
  '布加拉提': 'Bruno_Bucciarati.webp',
  '空条徐伦': 'Jolyne_Cujoh.webp',
  '迪亚波罗': 'Enrico_Pucci.webp',
  '杰洛·齐贝林': 'Gyro_Zeppeli.webp',
  '吉良吉影': 'Kira.webp',
  '福葛': 'Fugo.webp',
  ...
  '瓦姆乌': 'Wamuu.webp',
  '普奇神父': 'Pucci.webp',
  '法尼·瓦伦泰': 'Funny_Valentine.webp',
  '埃尔梅斯·科斯特洛': 'Costello.webp',
  '天气预报': 'Weather_Report.webp',
